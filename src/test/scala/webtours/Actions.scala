...
object Actions {
  ...
  val paymentDetailsResult: HttpRequestBuilder = http("paymentDetailsResult")
    ...
    .check(css("input[name=lastName]", "value").saveAs("lastName"))
    .check(css("input[name=address1]", "value").saveAs("address1"))
    .check(css("input[name=address2]", "value").saveAs("address2"))
    .check(css("input[name=pass1]", "value").saveAs("pass1"))
    .check(css("input[name=oldCCOption]", "value").saveAs("oldCCOption"))
    .check(css("input[name=returnFlight]", "value").saveAs("returnFlight"))
    .check(css("input[name=JSFormSubmit]", "value").saveAs("JSFormSubmit"))
